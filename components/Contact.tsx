...
export default function Contact() {
  ...
  const sendMessage = (platform: 'whatsapp' | 'wechat' | 'email') => {
    ...
    switch (platform) {
      case 'whatsapp':
        url = `https://wa.me/6281234567890?text=Nama: ${encodeURIComponent(formData.name)}%0AEmail: ${encodeURIComponent(formData.email)}%0ASubjek: ${encodeURIComponent(formData.subject)}%0APesan: ${encodeURIComponent(formData.message)}`;
        break;
      case 'wechat':
